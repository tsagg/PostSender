...
class MainWindow(Tk):
    ...
    def __init__(self):
        ...
        self.info_label = Label(self, text="Двухфакторная авторизация\nна аккаунте должна быть\nвыключена!",
        ...
        self.token_entry = Entry(self, show="*", width=58, font=('Arial', 8))
...
class ChannelEdit(Toplevel):
    ...
    def save(self, text):
        ...
        if edit_file('TgChatId.txt', text):
            mb.showinfo(title="Успешно!", message="Сохранение прошло успешно!")
            self.destroy()
